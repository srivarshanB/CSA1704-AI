...
target_dict = {i: target for i, target in enumerate(iris.target_names)}
...
tree.plot_tree(dtc, feature_names=names_features, class_names=target_labels, filled=True)
plt.show()
...
sns.heatmap(matrix, annot=True, fmt="g", ax=axis, cmap="viridis")
